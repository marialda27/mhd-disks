...
masse   = masse[which(2<re & re<7 & ze<1)]
...
enmage=0.125*modbe2/pi/rhoe*masse
...
ue      = masse*ue[which(2<re & re<7 & ze<1)]
encine  = 0.5*masse*modve2
...
par(mar=c(5, 5, 3, 3))
plot(seq(0,350,10),enmagemediana,log="y",xlab="time", ylab=expression(paste(E," ","[",erg,"]" )),
