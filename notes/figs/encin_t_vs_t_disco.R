...
vex=ve$x[which(rmin<re & re<rmax & ze<zlim)]
vey=ve$y[which(rmin<re & re<rmax & ze<zlim)]
vez=ve$z[which(rmin<re & re<rmax & ze<zlim)]
modve2=vex*vex + vey*vey + vez*vez

masse=masse[which(rmin<re & re<rmax & ze<zlim)]
...
vcx=vc$x[which(rmin<rc & rc<rmax & zc<zlim)]
vcy=vc$y[which(rmin<rc & rc<rmax & zc<zlim)]
vcz=vc$z[which(rmin<rc & rc<rmax & zc<zlim)]
modvc2=vcx*vcx + vcy*vcy + vcz*vcz

massc=massc[which(rmin<rc & rc<rmax & zc<zlim)]
