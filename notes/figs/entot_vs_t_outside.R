...
rhoc = rhoc[which(2<rc & zc>1)]
uc= rhoc*uc[which(2<rc & zc>1)]
...
par(mar=c(5, 5, 3, 3))
plot(seq(0,350,10),entotcmediana,log="y",xlab="time", ylab=expression(paste(E[tot]," ","[",erg/cm^3,"]" )),
