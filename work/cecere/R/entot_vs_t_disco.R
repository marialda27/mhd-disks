...
entote = enmage + ue + 0.5*rhoe*modve2
...
plot(seq(0,350,10),entotcmediana,log="y",xlab="time", ylab="E",yaxt="n",type="b",pch=21,col="red",ylim=c(min(entotcmediana,entotemediana),max(entotcmediana,entotemediana)))
...
title("Total energy inside the disk")
dev.off()
