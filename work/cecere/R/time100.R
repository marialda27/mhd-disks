...
rhoc=snap.read.2('snapshot_100_controlrun','RHO ',debug=1,gas=1) 
hc=hist(rhoc)
rhoe=snap.read.2('snapshot_100_etacs','RHO ',debug=1,gas=1) 
he=hist(rhoe)
...
title("Distribucion de densidad t=100")
dev.off()

# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 
# library('snapshot')
uc=snap.read.2('snapshot_100_controlrun','U   ',debug=1) 
ue=snap.read.2('snapshot_100_etacs','U   ',debug=1) 
...
# add a main title and bottom and left axis labels
title("Distribucion de energia interna t=100")

dev.off()

# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # d
# library('snapshot')
# rhoc=snap.read.2('snapshot_100_controlrun','RHO ',debug=1) 
# rhoe=snap.read.2('snapshot_100_etacs','RHO ',debug=1) 
# uc=snap.read.2('snapshot_100_controlrun','U   ',debug=1) 
# ue=snap.read.2('snapshot_100_etacs','U   ',debug=1)


# bc NO HAY INFO SOBRE EL CAMPO 
be=snap.read.2('snapshot_100_etacs',     'BFLD',debug=1,gas=1) 
vc=snap.read.2('snapshot_100_controlrun','VEL ',debug=1,gas=1) 
ve=snap.read.2('snapshot_100_etacs',     'VEL ',debug=1,gas=1) 
...
he=hist(entote)
# he=hist(entote,xlim=c(0,5),breaks=1000)

modvc=vc$x*vc$x+vc$y*vc$y+vc$z*vc$z
enmagc=0.*modvc
entotc=enmagc + uc + 0.5*rhoc*modvc*modvc
hc=hist(entotc)
# hc=hist(entotc,xlim=c(0,5),breaks=1000)
...
mtext("controlrun", side=4, line=3, cex.lab=1,las=2, col="red", at = 1100)  
# add a main title and bottom and left axis labels
title("Distribucion de densidad de energia total=100")
