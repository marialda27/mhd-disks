...
par(new=T)
lines(tt[3][[1]]$x,tt[3][[1]]$y,type="b", pch=22, col="blue", lty=2,yaxt="n",xaxt="n")
par(new=T)
lines(tt[4][[1]]$x,tt[4][[1]]$y,type="b", pch=22, col="blue", lty=2,yaxt="n",xaxt="n")
par(new=T)
lines(tt[5][[1]]$x,tt[5][[1]]$y,type="b", pch=22, col="blue", lty=2,yaxt="n",xaxt="n")
par(new=T)
lines(tt[6][[1]]$x,tt[6][[1]]$y,type="b", pch=22, col="blue", lty=2,yaxt="n",xaxt="n")
par(new=T)
lines(tt[7][[1]]$x,tt[7][[1]]$y,type="b", pch=22, col="blue", lty=2,yaxt="n",xaxt="n")
par(new=F)
