...
call campo(xkl,ykl,zkl,bxkl,bykl,bzkl)
! bxkl = ykl
! bykl = -xkl
! bzkl = 0.
...
call campo(xk1m,yk1m,zk1m,bxk1m,byk1m,bzk1m)
! bxk1m = yk1m
! byk1m = -xk1m
! bzk1m = 0.
...
! ultimo paso
call campo(xkm,ykm,zkm,bxkm,bykm,bzkm)
! bxkm = ykm
! bykm = -xkm
! bzkm = 0.
...
call campo(xskl,yskl,zskl,bxsk1,bysk1,bzsk1)
! bxsk1 = yskl
! bysk1 = -xskl
! bzsk1 = 0.
