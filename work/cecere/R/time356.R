...
rhoc=snap.read.2('snapshot_356_controlrun','RHO ',debug=1,gas=1) 
hc=hist(rhoc)
rhoe=snap.read.2('snapshot_356_etacs','RHO ',debug=1,gas=1) 
he=hist(rhoe)
...
title("Distribucion de densidad t=356")
dev.off()

# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 
# library('snapshot')
uc=snap.read.2('snapshot_356_controlrun','U   ',debug=1) 
ue=snap.read.2('snapshot_356_etacs','U   ',debug=1) 
...
# add a main title and bottom and left axis labels
title("Distribucion de energia interna t=356")
...
be=snap.read.2('snapshot_356_etacs',     'BFLD',debug=1,gas=1) 
vc=snap.read.2('snapshot_356_controlrun','VEL ',debug=1,gas=1) 
ve=snap.read.2('snapshot_356_etacs',     'VEL ',debug=1,gas=1) 
...
mtext("controlrun", side=4, line=3, cex.lab=1,las=2, col="red", at = 1100)  
# add a main title and bottom and left axis labels
title("Distribucion de densidad de energia total=356")
