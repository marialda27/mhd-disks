...
plot(seq(0,350,10),entotcmediana,log="y",xlab="time", ylab=expression(E[int]),yaxt="n",type="b",pch=21,col="red",ylim=c(min(entotcmediana,entotemediana),max(entotcmediana,entotemediana)))
...
mtext("etacs",   side=4, line=3,           las=2, col="blue",at=c(0.12))
